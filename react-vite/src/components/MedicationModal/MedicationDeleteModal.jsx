...
// console.log("I got to line 55")
  return (
    ...
    <h1 className="font-extrabold">{props.user.first_name} {"'s"} {theMed.name}</h1>
    <h2 className="font-bold">Are you sure you want to delete it?</h2>
    <section className="flex flex-row gap-6">
    <button className="shadow-xl shadow-black bg-red-200 border-solid border-4 border-black rounded-xl font-bold p-2 self-center hover:bg-red-100" onClick={handleYes}>Yes</button>
    <button className="shadow-xl shadow-black bg-red-200 border-solid border-4 border-black rounded-xl font-bold p-2 self-center hover:bg-red-100" onClick={handleNo}>No</button>
    </section>
    </section>
    </>
  );
